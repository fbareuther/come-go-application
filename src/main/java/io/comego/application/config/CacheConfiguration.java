package io.comego.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(io.comego.application.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(io.comego.application.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
