...
import io.comego.application.domain.Person;
import io.comego.application.repository.PersonRepository;
...
public class PersonResourceIntTest {
    ...
    public void createPerson() throws Exception {
        ...
        assertThat(testPerson.getUserName()).isEqualTo(DEFAULT_USER_NAME);
    ...
    public void updatePerson() throws Exception {
        ...
        Person testPerson = personList.get(personList.size() - 1);
        assertThat(testPerson.getUserName()).isEqualTo(UPDATED_USER_NAME);
